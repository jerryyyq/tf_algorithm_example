...
def gen_poetry():
	...
	with tf.Session() as sess:
		...
		state_ = sess.run(zero_state) # state_ = [[[[ 128 个 0 ]], [[ 128 个 0 ]]], [[[ 128 个 0 ]], [[ 128 个 0 ]]]]
		print('state_ 0: ', state_)
 
		x = np.array([list(map(word_num_map.get, '['))])   # x = [[3]]
		print('x', x)

		[probs_, state_] = sess.run([probs, last_state], feed_dict={input_data: x, initial_state: state_})
		print(probs_, state_)
		# probs_ = [[1.70141546e-04, 1.46433653e-04, ......, 1.17275678e-02, 4.50924809e-08]]
		# state_ = [[[[ 128 个 float32 ]], [[ 128 个 float32 ]]], [[[ 128 个 float32 ]], [[ 128 个 float32 ]]]]
		word = to_word(probs_)   # word 家
		print('word', word)
